...
### Katharina. Accepted. Contact and complexity in English varieties: The
### influence of speaker numbers on syntheticity and grammaticity. PLOS One.
...
# load demographic data; download from https://github.com/Morphosyntactic-Variation-in-Englishes/DOVE (version 1.0) and place in data directory or adjust paths accordingly; consult DOVE for the original copyright of the individual demographic data!

langs <- fread("data/languages_DOVE_v1.0.csv") # use version 1.0 or adjust filename
