...
### acquisition on morphosyntactic complexity operationalised as the number of
...
### Ehret, Katharina. Accepted. Contact and complexity in English varieties: The
...
SI_max <- glmer(SI ~ log10_natives + prop_non_natives +
			    ...
			    (1 + log10_natives + prop_non_natives |macro_region) + 
...
# decorrelate varying slopes as correlated slopes result in singular fit and are very highly correlated
